      ...
      if (token.content
        ...
        if (cross === ' ' || cross === 'x' || cross === 'o') {
          ...
          if (cross === ' ') {
			...
			checkbox.content = '<input type="checkbox" class="task-list-item-checkbox" checked disabled>'
		  }else {
            // checkbox.content = '<span class="task-list-item-checkbox checked" type="checkbox">&#9745;</span>';
            checkbox.content = '<input type="checkbox" class="task-list-item-checkbox" checked="true">'
          }
